...
class Config(object):
    ...
    OWNER_ID = 6402009857  # got to @Iro_m_bot and type /id
    OWNER_USERNAME = "The_clan_killer_12" # your telegram username
    ALLOW_CHATS = True # leave it as it is
    BOT_USERNAME = "Critical_pro_bot" # your bot username get it form @botfather
    SUPPORT_CHAT = "criticalsupport"  # Your own group for support, do not add the @ if you dont have leave it as it is
    UPDATES_CHANNEL = "criticalupdate"  # Your own chsnnel for support, do not add the @ if you dont have leave it as it is
    JOIN_LOGGER =  (
        -1002086511776
    ...
    SPAMWATCH_SUPPORT_CHAT = "@criticalsupport"
    ...
    DEV_USERS = [6402009857]
    ##List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    DEMONS = [6402009857]
    # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
    TIGERS = [6402009857]
    WOLVES = [6402009857]
    START_IMG = "https://telegra.ph/file/a77927c8842de33eb396e.jpg" #yor fav img link
    CERT_PATH = None
    PORT = 5000
