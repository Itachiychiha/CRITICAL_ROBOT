...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("IRO/bg.jpg")
    ...
    font = ImageFont.truetype('IRO/SwanseaBold-D0ox.ttf', size=40)
    welcome_font = ImageFont.truetype('IRO/SwanseaBold-D0ox.ttf', size=60)
...
๏ ᴍᴀᴅᴇ ʙʏ ➠ [ɢᴏᴅ ᴏғ ɢᴇɴᴊᴜᴛsᴜ](https://t.me/aboutitachi9)**
""",
