...
PHOTO = [
    "https://telegra.ph/file/6f4642d3e1f97882a9a65.jpg",
    "https://telegra.ph/file/44158f95ad88fc9b7f7e0.jpg",
]
...
async def awake(event):
    ...
    TEXT += f"» **ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀs​ : [ꫝ. ɪᴛᴀᴄʜɪ ᴜᴄʜɪʜᴀ](https://t.me/{OWNER_USERNAME})\n\n"
